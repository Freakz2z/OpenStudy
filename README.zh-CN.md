...
[English](README.md) · [简体中文](README.zh-CN.md) · [参与贡献](CONTRIBUTING.md) · [Releases](https://github.com/Freakz2z/OpenStudy/releases) · [更新日志](CHANGELOG.md) · [反馈问题](https://github.com/Freakz2z/OpenStudy/issues)

</div>

<p align="center">
  <img src=".github/assets/usage-flow.png" alt="OpenStudy 从资料导入、可编辑 Markdown、结构化题目到做题、考试、AI 辅助、做题记录、错题复盘与洞察的完整流程" width="100%">
</p>
...
<p align="center">
  <img src=".github/assets/openstudy-workflow.gif" alt="OpenStudy 真实流程演示 GIF，展示从导入 Markdown、检查源码、Markdown 题目做题、问 AI、查看做题记录、错题重做到手动生成洞察的完整链路" width="100%">
</p>

上面的演示对应当前应用里的真实主流程：`导入 Markdown -> 检查源码 -> 开始做题 -> 问 AI -> 做题记录 -> 错题本 -> 重做 -> 生成洞察`。
...
<details>
  <summary><strong>健康检查、安装与转换</strong></summary>
...
<details>
  <summary><strong>题目与标准</strong></summary>
...
<details>
  <summary><strong>做题、错题本与统计</strong></summary>
...
<details>
  <summary><strong>AI 与设置</strong></summary>
