...
<p align="center">
  <img src=".github/assets/openstudy-workflow.gif" alt="OpenStudy 真实流程演示 GIF，展示从导入 Markdown、检查源码、做题、问 AI、错题重做到手动生成洞察的完整链路" width="100%">
</p>

上面的演示对应当前应用里的真实主流程：`导入 Markdown -> 检查源码 -> 开始做题 -> 问 AI -> 错题本 -> 重做 -> 生成洞察`。
